    ...
    <div class="view__approval container">
            ...
            <div class="grid3">
               <div class="form__item form__group-item">
                    ...
                    <label class="form__label">Status:<span class="form__weight"> <?php echo $data['applicant']->status?></span></label>

                    <div class="grid-2">
                         <?php if($data['applicant']->status == "Evaluation"):?>
                         <form action="<?php echo URLROOT . '/admins/viewUser/' . $data['applicant']->users_id?>" method="POST">
                              <button class="form__btn">Approve</button>
                         </form>
                         <?php else:?>
                              <?php if($data['applicant']->status == "For Submission"):?>
                                   <form action="<?php echo URLROOT . '/admins/enroll/' . $data['applicant']->users_id?>" method="POST">
                                        <button class="form__btn">Enroll</button>
                                   </form>
                                   <?php endif;?>
                         <?php endif;?>
                              <?php if($data['applicant']->status != "Enrolled"):?>
                        
                                   <a class="form__btn" href="<?php echo URLROOT . '/admins/reject/' . $data['applicant']->users_id?>">Reject</a>
                                   <?php endif;?>
            ...
            <div class="form__item">
               ...
               <img id="myImg" src="<?php echo URLROOT . "/public/applicantimage/".$data['applicant']->oneByOne;?>" alt="1x1 picture" width="200" height="200">
                    <!-- The Modal -->
                    <div id="myModal" class="modal">
                         <img class="modal-content" id="img02">
                         <div id="caption"></div>
